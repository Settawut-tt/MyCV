...
import Tormonto from "./Assets/Projects/Tormonto.jpg";
...
export const PROJECTS = [
  {
    image: Tormonto,
    name: " Tormonto",
    technologyUsed: "ReactJs, Javascript, Jest",
    description: "Front-End Web design with React",
    url: "https://www.tormonto.com/",
  },
  {
    image: Jamming,
    name: "jsd-1-react-jamming.vercel.app/",
    ...
    url: "https://jsd-1-react-jamming.vercel.app/",
  },
  {
    image: COAST,
    name: "Coast",
...
export const TOOLS = ["Visual Studio Code", "Git", "Chrome DevTools", "Npm (Node Package Manager)", "Atom", "Sublime Text", "Vercel", "Postman"]
